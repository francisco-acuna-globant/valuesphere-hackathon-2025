sap.ui.define([
	...
	"sap/m/MessageItem",
	"hackathon/valuesphere/cashflow/forecast/upload/ext/utils/SpreadsheetHelper"
	...
	return ControllerExtension.extend('hackathon.valuesphere.cashflow.forecast.upload.ext.controller.ListReportExtension', {
		...
		onMassUpload: function () {
			...
			if (!this._spreadsheetDialog) {
				Fragment.load({
					id: this.oView.getId(),
					name: "hackathon.valuesphere.cashflow.forecast.upload.ext.fragments.SpreadsheetUploadDialog",
					controller: this,
				}).then((oDialog) => {
