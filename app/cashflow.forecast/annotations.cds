...
annotate CashflowForecastService.CashflowWeeklyForecasts with @UI.HeaderInfo: {
  TypeName      : 'Cashflow Weekly Forecast',
  TypeNamePlural: 'Cashflow Weekly Forecasts',
  Title         : {Value: sourceType}
};
...
annotate CashflowForecastService.CashflowWeeklyForecasts with @UI.SelectionFields: [sourceType];
